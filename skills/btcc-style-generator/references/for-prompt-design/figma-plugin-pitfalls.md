...
> Per `rules.md` R-SSOT-1, this file owns runtime gotchas observed when generating BTCC nodes via `use_figma`. It is platform-neutral. New gotchas should be added here, not redocumented per platform.
